      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-slate-600">Bộ công cụ và công nghệ tôi sử dụng để xây dựng sản phẩm</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {SKILL_CATEGORIES.map((category, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:-translate-y-1 transition-transform duration-300">
        ...
        <div>
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">Computer Science Fundamentals</h2>
          </div>
